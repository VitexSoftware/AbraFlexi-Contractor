...
**Purpose**: ![project logo](project-logo.svg?raw=true)
**Status**: Active
**Repository**: git@github.com:VitexSoftware/AbraFlexi-Contractor.git
...
git clone git@github.com:VitexSoftware/AbraFlexi-Contractor.git
cd AbraFlexi-Contractor
...
### Build & Run
```bash
dpkg-buildpackage -b -uc\ndocker build -t AbraFlexi-Contractor .
```
