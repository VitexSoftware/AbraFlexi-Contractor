...
class PageBottom extends \Ease\Html\FooterTag
{
    public function __construct($content = null, array $properties = [])
    {
        ...
        $author = '<strong>'._('AbraFlexi Contractor').'</strong> '.\Ease\Shared::appVersion().'<br>&nbsp;&nbsp; &copy; 2024 <a href="https://vitexsoftware.com/">VitexSoftware</a>';
